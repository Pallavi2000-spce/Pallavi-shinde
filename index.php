...
<body >
	...
	<div id="header">
       <br>
	   <h1 style=" color:white; background-color:navy;font-size:50px;color:white;">STATE BANK</h1>
       <h1 style=" font-family:Agency FB; font-size: 60px; color:red;text-shadow: 2px 4px yellow;"> GRIP PROJECT </h1>
       <h2 style=" font-family:Agency FB; font-size: 55px;color:#ee10ee;text-shadow: 2px 2px black;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </h2>
    </div>
        <div id="section">
            <table>
                <tr></tr>
